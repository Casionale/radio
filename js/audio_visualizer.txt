class AudioVisualizer {
    constructor(audioElement, svgElement) {
        ...
        // Circle movement properties - движение вокруг центра
        ...
        this.moveInterval = 18000; // Изменение направления каждые 18 секунд (еще медленнее)
    ...
    animate() {
        ...
        // Update circle positions every few seconds
        if (currentTime - this.lastUpdateTime > this.moveInterval) {
            this.updateCircleTargets();
            this.lastUpdateTime = currentTime;
        }

        // Animate circle positions smoothly with organic movement
        ...
        this.updateCircle(0, bassRange, this.baseRadii[0]);      // Circle 1 - bass
        this.updateCircle(1, midRange, this.baseRadii[1]);     // Circle 2 - mids
        this.updateCircle(2, trebleRange, this.baseRadii[2]);     // Circle 3 - treble
    ...
    updateCircle(circleIndex, volume, baseRadius) {
        ...
        // Calculate new radius based on volume (0-255 range)
    ...
    // Method to handle play/pause events
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (audioElement && svgElement) {
        ...
        // Also listen for click events on play button
